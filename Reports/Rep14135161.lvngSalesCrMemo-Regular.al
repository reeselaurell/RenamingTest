    ...
    dataset
    {
        dataitem(lvngSalesCrMemoHeader; "Sales Cr.Memo Header")
        {
            ...
            dataitem(lvngSalesCrMemoLine; "Sales Cr.Memo Line")
            {
                ...
                column(LineLoanNo; lvngSalesCrMemoLine.lvngLoanNo)
                {
                ...
                begin
                    Clear(BorrowerName);
                    if lvngSalesCrMemoLine.lvngLoanNo <> '' then begin
                        if Loan.Get(lvngSalesCrMemoLine.lvngLoanNo) then
            ...
            begin
                ...
                if lvngSalesCrMemoHeader.lvngLoanNo <> '' then begin
                    if DefaultDimension.Get(Database::lvngLoan, lvngSalesCrMemoHeader.lvngLoanNo, LoanVisionSetup.lvngCostCenterDimensionCode) then begin
                    ...
                    if DefaultDimension.Get(Database::lvngLoan, lvngSalesCrMemoHeader.lvngLoanNo, LoanVisionSetup.lvngLoanOfficerDimensionCode) then begin
                        if DimensionValue.Get(DefaultDimension."Dimension Code", DefaultDimension."Dimension Value Code") then begin
