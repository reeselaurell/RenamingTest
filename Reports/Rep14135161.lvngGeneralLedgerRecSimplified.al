report 14135161 lvngGeneralLedgerRecSimplified
{
    ...
    dataset
    {
        dataitem(GLAccount; "G/L Account")
        {
            ...
            dataitem(Cycle; Integer)
            {
                ...
                dataitem(GLEntry; "G/L Entry")
                {
                    ...
                    begin
                        ...
                        SetRange(lvngLoanNo, TempGLEntryBuffer."Loan No.");
                ...
                begin
                    ...
                    if Loan.Get(TempGLEntryBuffer."Loan No.") then
                        if not DefaultDimension.Get(Database::lvngLoan, TempGLEntryBuffer."Loan No.", LoanVisionSetup."Loan Type Dimension Code") then
                            Clear(DefaultDimension);
                    Counter := 0;
                end;
            }
            ...
            trigger OnAfterGetRecord()
            var
                EntriesByLoanSums: Query lvngGLEntriesByLoanSums;
                LineNo: Integer;
            begin
                TempGLEntryBuffer.Reset();
