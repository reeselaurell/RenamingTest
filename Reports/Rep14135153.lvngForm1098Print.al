report 14135153 lvngForm1098Print
{
    ...
    dataset
    {
        dataitem(RequestEntry; lvngForm1098Entry)
        {
            UseTemporary = true;
    ...
    var
        ...
        BaseForm1098Entry: Record lvngForm1098Entry;
        Form1098Entry1: Record lvngForm1098Entry temporary;
        Form1098Entry2: Record lvngForm1098Entry temporary;
        EncryptSSN: Boolean;
        LenderNameBox: Text;
        LenderEIN: Text;
        BorrowerSSN1: Text;
