report 14135158 lvngAverageDailyTrialBalance
{
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            RequestFilterFields = "Date Filter", "Global Dimension 1 Filter", "Global Dimension 2 Filter", lvngShortcutDimension3Filter, lvngShortcutDimension4Filter, "Income/Balance";
    ...
    var
        ...
        DateTo: Date;
        TotalDays: Integer;
        PrintType: Enum lvngDailyTrialBalancePrintType;
