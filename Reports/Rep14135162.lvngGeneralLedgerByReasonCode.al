report 14135162 lvngGeneralLedgerByReasonCode
{
        ...
        dataitem(GLAccount; "G/L Account")
        {
            ...
            begin
                ...
                if DateOption = DateOption::"Posting Date" then begin
                    ...
                    GLEntry.SetCurrentKey("G/L Account No.", lvngEntryDate);
                    GLEntry.SetFilter(lvngEntryDate, '%1..%2', 0D, MaxDate);
                end;
    ...
    var
        ...
        GLPerReasonCode: Query lvngGLReportPerReasonCode;
        DateFilter: Text;
        ReasonFilter: Text;
        ...
        MaxDate: Date;
        GLAccountName: Text;
        DateOption: Enum lvngDocumentDateTypes;
