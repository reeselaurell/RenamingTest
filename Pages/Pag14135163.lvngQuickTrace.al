page 14135163 lvngQuickTrace
{
    ...
    layout
    {
        ...
        area(FactBoxes)
        {
            part(LoanFactBox; lvngLoanInfoBox)
            {
                Caption = 'Information';
    ...
    var
        ...
        LoanDocInvoiceLF: Record lvngLoanFundedDocument;
        LoanDocCreditLF: Record lvngLoanFundedDocument;
        LoanDocInvoiceLP: Record lvngLoanSoldDocument;
        LoanDocCreditLP: Record lvngLoanSoldDocument;
