codeunit 14135121 lvngFilesImportAutomation
{
    TableNo = "Job Queue Entry";

    trigger OnRun()
    var
        ImportJobSchedulerTask: Record lvngImportJobSchedulerTask;
        ImportJobSchedulerLog: Record lvngImportJobSchedulerLog;
    ...
    [TryFunction]
    procedure ProcessFileImport(var ImportJobSchedulerTask: Record lvngImportJobSchedulerTask; FileName: Text; ImportID: Guid)
    begin
    ...
    local procedure CalcJournalStatistics(var ImportJobSchedulerTask: Record lvngImportJobSchedulerTask; var ImportJobSchedulerLog: Record lvngImportJobSchedulerLog)
    var
    ...
    begin
        ...
        GenJnlLine.SetRange(lvngImportID, ImportJobSchedulerLog."Import ID");
    ...
    local procedure PostGeneralJournal(var ImportJobSchedulerTask: Record lvngImportJobSchedulerTask): Boolean
    var
        GenJnlLine: Record "Gen. Journal Line";
    ...
    local procedure ProcessGeneralJournalImportFile(var ImportJobSchedulerTask: Record lvngImportJobSchedulerTask; FileName: Text; ImportID: Guid)
    var
        GenJnlImportBuffer: Record lvngGenJnlImportBuffer temporary;
        ImportBufferError: Record lvngImportBufferError temporary;
        GenJnlFileImportMgmt: Codeunit lvngGenJnlFileImportManagement;
    begin
    ...
    local procedure ProcessLoanImportFile(var ImportJobSchedulerTask: Record lvngImportJobSchedulerTask; FileName: Text)
    var
