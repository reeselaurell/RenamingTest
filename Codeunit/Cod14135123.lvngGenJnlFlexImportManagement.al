codeunit 14135123 lvngGenJnlFlexImportManagement
{
    var
    ...
    begin
        ...
        repeat
            ...
            GenJnlLine.lvngServicingType := GenJnlImportBuffer."Servicing Type";
            GenJnlLine.Validate(lvngLoanNo, GenJnlImportBuffer."Loan No.");
    ...
    var
        ...
        LoanExists: Boolean;
        ValueAssignType: Enum lvngFlexImportAssignTarget;
    begin
    ...
    var
        FlexImportSchemaExpression: Record lvngFlexImportSchemaExpression;
    ...
    var
        FlexibleImportSchemaLine: Record lvngFlexibleImportSchemaLine;
        BaseGenJnlImportBuffer: Record lvngGenJnlImportBuffer temporary;
