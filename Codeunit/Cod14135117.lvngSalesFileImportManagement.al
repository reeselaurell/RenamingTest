codeunit 14135117 "lvngSalesFileImportManagement"
{
    ...
    begin
        ...
        repeat
            ...
            lvngFileImportJnlLineTemp.SetFilter(lvngSalesImportFieldType, '<>%1', lvngFileImportJnlLine.lvngSalesImportFieldType::lvngDummy);
            ...
            repeat
                ...
                if lvngValue <> '' then begin
                    case lvngFileImportJnlLineTemp.lvngSalesImportFieldType of
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngAccountNo:
                            begin
                        ...
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngAmount:
                            begin
                                Evaluate(lvngGenJnlImportBuffer.lvngAmount, lvngValue);
                            end;
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDescription:
                            begin
                                lvngGenJnlImportBuffer.lvngDescription := CopyStr(lvngValue, 1, MaxStrLen(lvngGenJnlImportBuffer.lvngDescription));
                            end;
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension1Code:
                            begin
                        ...
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension2Code:
                            begin
                        ...
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension3Code:
                            begin
                        ...
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension4Code:
                            begin
                        ...
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension5Code:
                            begin
                        ...
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension6Code:
                            begin
                        ...
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension7Code:
                            begin
                        ...
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension8Code:
                            begin
                        ...
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngLoanNo:
                            begin
                                lvngGenJnlImportBuffer.lvngLoanNo := CopyStr(lvngValue, 1, MaxStrLen(lvngGenJnlImportBuffer.lvngLoanNo));
                            end;
                        lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngReasonCode:
                            begin
    ...
    begin
        if lvngLoan.Get(lvngGenJnlImportBuffer.lvngLoanNo) then begin
            lvngFileImportJnlLineTemp.reset;
            lvngFileImportJnlLineTemp.SetRange(lvngSalesImportFieldType, lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension1Code);
            if lvngFileImportJnlLineTemp.IsEmpty() then
                lvngGenJnlImportBuffer.lvngGlobalDimension1Code := lvngLoan."Global Dimension 1 Code";

            lvngFileImportJnlLineTemp.SetRange(lvngSalesImportFieldType, lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension2Code);
            if lvngFileImportJnlLineTemp.IsEmpty() then
                lvngGenJnlImportBuffer.lvngGlobalDimension2Code := lvngLoan."Global Dimension 2 Code";

            lvngFileImportJnlLineTemp.SetRange(lvngSalesImportFieldType, lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension3Code);
            if lvngFileImportJnlLineTemp.IsEmpty() then
                lvngGenJnlImportBuffer.lvngShortcutDimension3Code := lvngLoan."Shortcut Dimension 3 Code";

            lvngFileImportJnlLineTemp.SetRange(lvngSalesImportFieldType, lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension4Code);
            if lvngFileImportJnlLineTemp.IsEmpty() then
                lvngGenJnlImportBuffer.lvngShortcutDimension4Code := lvngLoan."Shortcut Dimension 4 Code";

            lvngFileImportJnlLineTemp.SetRange(lvngSalesImportFieldType, lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension5Code);
            if lvngFileImportJnlLineTemp.IsEmpty() then
                lvngGenJnlImportBuffer.lvngShortcutDimension5Code := lvngLoan."Shortcut Dimension 5 Code";

            lvngFileImportJnlLineTemp.SetRange(lvngSalesImportFieldType, lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension6Code);
            if lvngFileImportJnlLineTemp.IsEmpty() then
                lvngGenJnlImportBuffer.lvngShortcutDimension6Code := lvngLoan."Shortcut Dimension 6 Code";

            lvngFileImportJnlLineTemp.SetRange(lvngSalesImportFieldType, lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension7Code);
            if lvngFileImportJnlLineTemp.IsEmpty() then
                lvngGenJnlImportBuffer.lvngShortcutDimension7Code := lvngLoan."Shortcut Dimension 7 Code";

            lvngFileImportJnlLineTemp.SetRange(lvngSalesImportFieldType, lvngFileImportJnlLineTemp.lvngSalesImportFieldType::lvngDimension8Code);
            if lvngFileImportJnlLineTemp.IsEmpty() then
                lvngGenJnlImportBuffer.lvngShortcutDimension8Code := lvngLoan."Shortcut Dimension 8 Code";
        end;
    end;
