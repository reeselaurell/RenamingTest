table 14135144 lvngForm1098Details
{
    Caption = 'Form 1098 Details';
    DataClassification = CustomerContent;
    LookupPageId = lvngForm1098Details;

    fields
    {
        field(1; "Loan No."; Code[20]) { DataClassification = CustomerContent; Caption = 'Loan No.'; TableRelation = lvngLoan; }
        ...
        field(10; Type; Enum lvngForm1098EntryType) { DataClassification = CustomerContent; Caption = 'Type'; }
        ...
        field(15; "Rule Description"; Text[50]) { FieldClass = FlowField; Caption = 'Rule Description'; CalcFormula = lookup (lvngForm1098ColRuleDetails.Description where("Box No." = field("Box No."), "Line No." = field("Rule Line No."))); }
