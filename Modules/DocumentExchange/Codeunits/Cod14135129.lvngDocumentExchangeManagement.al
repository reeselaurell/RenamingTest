codeunit 14135129 lvngDocumentExchangeManagement
{
    var
        DocumentExchangeSetup: Record lvngDocumentExchangeSetup;
        DocumentGuidTxt: Label 'lvngDocumentGuid';
    ...
    local procedure SetupDocumentLine(var DocumentExchangeLine: Record lvngDocumentExchangeLine)
    var
        Idx: Integer;
        PlainFileName: Text;
        FileExtension: Text;
    ...
    var
        DocumentExchangeLog: Record lvngDocumentExchangeLog;
    begin
        if CompanyName <> '' then
