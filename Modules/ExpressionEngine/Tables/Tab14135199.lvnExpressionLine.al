table 14135199 "lvnExpressionLine"
{
    fields
    {
        ...
        field(3; "Line No."; Integer) { NotBlank = true; DataClassification = CustomerContent; }
        field(4; "Split No."; Integer) { DataClassification = CustomerContent; }
        field(10; "Left Side"; Text[250]) { DataClassification = CustomerContent; }
        field(11; Comparison; Enum lvnComparison) { DataClassification = CustomerContent; }
