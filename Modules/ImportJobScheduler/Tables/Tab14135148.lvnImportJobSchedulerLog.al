table 14135148 "lvnImportJobSchedulerLog"
{
    ...
    fields
    {
        ...
        field(10; "Job Scheduler Task Code"; Code[20]) { Caption = 'Job Scheduler Task Code'; DataClassification = CustomerContent; TableRelation = lvnImportJobSchedulerTask.Code; }
