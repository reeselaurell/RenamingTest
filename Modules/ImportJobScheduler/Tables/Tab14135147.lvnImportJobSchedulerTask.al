table 14135147 "lvnImportJobSchedulerTask"
{
    ...
    fields
    {
        ...
        field(10; Type; Enum lvnImportSchedulerTaskType) { Caption = 'Type'; DataClassification = CustomerContent; }
        ...
        field(14; "Data Import Schema Code"; Code[20]) { Caption = 'Data Import Schema Code'; DataClassification = CustomerContent; TableRelation = if (Type = const("General Journal")) lvnFileImportSchema.Code where("File Import Type" = const("General Journal")) else if (Type = const("Loan Journal")) lvnLoanImportSchema.Code; }
        field(15; "Loan Journal Type"; Enum lvnLoanJournalBatchType) { Caption = 'Loan Journal Type'; DataClassification = CustomerContent; }
        field(16; "Loan Journal Batch"; Code[20]) { Caption = 'Loan Journal Batch'; DataClassification = CustomerContent; TableRelation = lvnLoanJournalBatch.Code where("Loan Journal Type" = field("Loan Journal Type")); }
