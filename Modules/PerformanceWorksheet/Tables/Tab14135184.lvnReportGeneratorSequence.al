table 14135184 "lvnReportGeneratorSequence"
{
    ...
    fields
    {
        field(1; "Batch Code"; Code[20]) { Caption = 'Batch Code'; DataClassification = CustomerContent; TableRelation = lvnReportGeneratorBatch; }
        ...
        field(11; "Row Layout"; Code[20]) { Caption = 'Row Layout'; DataClassification = CustomerContent; TableRelation = lvnPerformanceRowSchema.Code where("Schema Type" = const(Period)); }
        field(12; "Band Layout"; Code[20]) { Caption = 'Band Layout'; DataClassification = CustomerContent; TableRelation = lvnPerformanceColSchema.Code; }
        field(13; "Expand Filter"; Enum lvnReportGeneratorFilterExpansion) { Caption = 'Expand Filter'; DataClassification = CustomerContent; }
