table 14135187 "lvnLoanLevelValueBuffer"
{
    ...
    fields
    {
        ...
        field(10; "Value Type"; Enum lvnLoanLevelValueType)
        {
            Caption = 'Value Type';
            DataClassification = CustomerContent;
        }
        field(11; "Raw Value"; Text[250])
        {
            Caption = 'Raw Value';
            DataClassification = CustomerContent;
        }
        ...
        field(13; "Date Value"; Date)
        {
            Caption = 'Date Value';
            DataClassification = CustomerContent;
        }
        field(14; "Number Format Code"; Code[20])
        {
