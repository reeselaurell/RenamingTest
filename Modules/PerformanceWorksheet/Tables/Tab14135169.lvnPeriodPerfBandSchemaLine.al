table 14135169 "lvnPeriodPerfBandSchemaLine"
{
    ...
    fields
    {
        field(1; "Schema Code"; Code[20]) { Caption = 'Schema Code'; DataClassification = CustomerContent; TableRelation = lvnPeriodPerfBandSchema.Code; }
        ...
        field(10; "Period Type"; Enum lvnPerformancePeriodType) { Caption = 'Period Type'; DataClassification = CustomerContent; }
        ...
        field(20; "Band Type"; Enum lvnPerformanceBandType) { Caption = 'Band Type'; DataClassification = CustomerContent; }
