table 14135174 "lvnCalculationUnit"
{
    ...
    fields
    {
        ...
        field(11; Type; Enum lvnCalculationUnitType) { Caption = 'Type'; DataClassification = CustomerContent; }
        //For Type::Constant
        ...
        field(30; "Lookup Source"; Enum lvnPerformanceLineSourceType) { Caption = 'Lookup Source'; DataClassification = CustomerContent; }
        //For "Lookup Source"::"Loan Card"
        field(31; "Based On Date"; Enum lvnLoanDateType) { Caption = 'Based On Date'; DataClassification = CustomerContent; }
        ...
        field(33; "Amount Type"; Enum lvnPerformanceAmountType) { Caption = 'Amount Type'; DataClassification = CustomerContent; }
        //For "Lookup Source"::"Loan Values"
        field(34; "Field No."; Integer) { Caption = 'Field No.'; DataClassification = CustomerContent; TableRelation = lvnLoanFieldsConfiguration."Field No." where("Value Type" = filter(Decimal | Integer)); }
        //For Type::Expression
