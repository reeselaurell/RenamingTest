table 14135167 "lvnPerformanceRowSchemaLine"
{
    ...
    fields
    {
        field(1; "Schema Code"; Code[20])
        {
            Caption = 'Schema Code';
            DataClassification = CustomerContent;
            TableRelation = lvnPerformanceRowSchema.Code;
        }
        ...
        field(11; "Row Type"; Enum lvnPerformanceRowType)
        {
            Caption = 'Row Type';
            DataClassification = CustomerContent;
        }
        field(12; "Calculation Unit Code"; Code[20])
        {
        ...
        field(14; "Style Code"; Code[20])
        {
            Caption = 'Style Code';
            DataClassification = CustomerContent;
            TableRelation = lvnStyle.Code;
        }
        field(15; "Neg. Style Code"; Code[20])
        {
            Caption = 'Negative Style Code';
            DataClassification = CustomerContent;
            TableRelation = lvnStyle.Code;
        }
        field(16; "Hide Zero Line"; Boolean)
        {
            Caption = 'Hide Zero Line';
            DataClassification = CustomerContent;
        }
        field(17; "Row Style"; Code[20])
        {
            Caption = 'Row Style';
            DataClassification = CustomerContent;
            TableRelation = lvnStyle.Code;
        }
        field(50; "Data Row Index"; Integer)
        {
            Caption = 'Data Row Index';
            DataClassification = CustomerContent;
            Description = 'For use in excel export';
        }
    }
