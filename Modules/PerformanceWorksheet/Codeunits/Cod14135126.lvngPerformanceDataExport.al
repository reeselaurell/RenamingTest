codeunit 14135126 lvngPerformanceDataExport
{
    var
    ...
    procedure ExportToExcel(var ExcelExport: Codeunit lvngExcelExport; var RowSchema: Record lvngPerformanceRowSchema; var Buffer: Record lvngPerformanceValueBuffer; var HeaderData: Record lvngSystemCalculationFilter; var BandInfo: Record lvngPerformanceBandLineInfo)
    var
    ...
    local procedure TranslateColFormula(Formula: Text; DataRowOffset: Integer; DataColOffset: Integer; BandIdx: Integer; BandSize: Integer; var Buffer: Record lvngPerformanceValueBuffer; var RowIndexLookup: Dictionary of [Integer, Integer]): Text
    var
        FieldStart: Integer;
        FieldEnd: Integer;
    begin
    ...
    local procedure TranslateColSwitch(SwitchOn: Text; var ExpressionHeader: Record lvngExpressionHeader; DataRowOffset: Integer; DataColOffset: Integer; BandIdx: Integer; BandSize: Integer; var Buffer: Record lvngPerformanceValueBuffer; var RowIndexLookup: Dictionary of [Integer, Integer]) Result: Text;
    var
    ...
    local procedure TranslateColPredicate(var ExpressionHeader: Record lvngExpressionHeader; DataRowOffset: Integer; DataColOffset: Integer; BandIdx: Integer; BandSize: Integer; var Buffer: Record lvngPerformanceValueBuffer; var RowIndexLookup: Dictionary of [Integer, Integer]): Text
    var
    ...
    local procedure TranslateColFormulaField(Field: Text; DataRowOffset: Integer; DataColOffset: Integer; BandIdx: Integer; BandSize: Integer; var Buffer: Record lvngPerformanceValueBuffer; var RowIndexLookup: Dictionary of [Integer, Integer]): Text
    var
        ExcelExport: Codeunit lvngExcelExport;
        RowIdx: Integer;
    begin
