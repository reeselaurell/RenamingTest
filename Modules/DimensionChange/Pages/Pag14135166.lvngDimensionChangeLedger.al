page 14135166 lvngDimensionChangeLedger
{
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field("Old Dimension Set ID"; Rec."Old Dimension Set ID") { ApplicationArea = All; }
                field("New Dimension Set ID"; Rec."New Dimension Set ID") { ApplicationArea = All; }
            }
        }
    }
