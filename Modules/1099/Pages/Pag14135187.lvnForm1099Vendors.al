page 14135187 "lvnForm1099Vendors"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Administration;
    SourceTable = lvn1099VendorLine;
    ...
    actions
    {
        area(Processing)
        {
                ...
                begin
                    ...
                    if Vendor.FindSet() then
                        repeat
                            ...
                            Rec."Legal Address" := Vendor.lvnLegalAddress;
                            Rec."Legal Address City" := Vendor.lvnLegalCity;
                            Rec."Legal Address State" := Vendor.lvnLegalState;
                            Rec."Legal Address ZIP Code" := Vendor.lvnLegalZIPCode;
            ...
            action(CalcPayments)
            {
                ...
                trigger OnAction()
                var
                    Calc1099Payments: Report lvnForm1099CalcVendPayments;
                begin
                    Rec.Reset();
                    if Rec.IsEmpty then
                        Error(NoVendorsErr);
            ...
            action(IRSData)
            {
                ...
                trigger OnAction()
                var
                    MagMedia1099: Report lvnForm1099MagneticMedia;
                begin
                    Rec.FindFirst();
                    Rec.Year := Rec.Year;
                    if Rec.Year = 0 then
            ...
            action(Printout)
            {
                ...
                trigger OnAction()
                var
                    Printout: Report lvnForm1099Printout;
                begin
                    Rec.FindFirst();
                    Rec.Year := Rec.Year;
                    if Rec.Year = 0 then
            ...
            action(Export)
            {
                ...
                trigger OnAction()
                var
                    Export1099: Report lvnForm1099ExcelExport;
                begin
                    if Rec.Year = 0 then
                        Error(CalcErr);
                    Commit();
