table 14135191 "lvnCloseManagerEntryHeader"
{
    ...
    fields
    {
        ...
        field(11; "Total Tasks"; Integer)
        {
            ...
            CalcFormula = count(lvnCloseManagerEntryLine where("Template No." = field("Template No.")));
            Editable = false;
        }
        field(12; "Outstanding Reconcilliations"; Integer)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = count(lvnCloseManagerEntryLine where("Template No." = field("Template No."), "Reconciled Date" = filter('')));
            Editable = false;
        }
        field(13; "Tasks Awaiting Approval"; Integer)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = count(lvnCloseManagerEntryLine where("Template No." = field("Template No."), "Awaiting Approval" = const(true)));
            Editable = false;
        }
        field(14; "Tasks Approved"; Integer)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = count(lvnCloseManagerEntryLine where("Template No." = field("Template No."), Approved = const(true)));
            Editable = false;
        }
