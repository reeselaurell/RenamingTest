table 14135196 "lvnCloseManagerArchEntryLine"
{
    ...
    fields
    {
        ...
        field(10; "Task Category"; Code[20]) { Caption = 'Task Category'; DataClassification = CustomerContent; TableRelation = lvnCloseManagerCategory; Editable = false; }
        ...
        field(101; "Period Date"; Date) { Caption = 'Period Date'; FieldClass = FlowField; CalcFormula = lookup(lvnCloseManagerArchEntryHdr."Period Date" where("No." = field("No."))); }
