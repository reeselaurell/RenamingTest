table 14135194 "lvnCloseManagerArchEntryHdr"
{
    DataClassification = CustomerContent;
    LookupPageId = lvnCloseManagerArchEntryList;
    DrillDownPageId = lvnCloseManagerArchEntryList;
    ...
    trigger OnDelete()
    var
        CloseManagerArchEntryLine: Record lvnCloseManagerArchEntryLine;
    begin
