table 14135196 "lvnCloseManagerArchEntryLine"
{
    ...
    fields
    {
        ...
        field(10; "Task Category"; Code[20])
        {
        ...
        field(17; "G/L Total"; Decimal)
        {
            ...
            CalcFormula = sum("G/L Entry".Amount where("G/L Account No." = field("Account Number")));
            Editable = false;
        }
        ...
        field(101; "Period Date"; Date)
        {
            Caption = 'Period Date';
            FieldClass = FlowField;
            CalcFormula = lookup(lvnCloseManagerArchEntryHdr."Period Date" where("No." = field("No.")));
        }
