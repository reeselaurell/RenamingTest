page 14135237 "lvnCloseManagerArchEntrySubFm"
{
    PageType = ListPart;
    SourceTable = lvnCloseManagerArchEntryLine;
    Editable = false;
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field("G/L Total"; Rec."G/L Total")
                {
                    ApplicationArea = All;
                }
                field("Reconciled Total"; Rec."Reconciled Total")
                {
                    ApplicationArea = All;
                }
                ...
                field("Reconciled Date"; Rec."Reconciled Date")
                {
                    ApplicationArea = All;
                }
                ...
                field("Awaiting Approval"; Rec."Awaiting Approval")
                {
                    ApplicationArea = All;
                }
