table 14135142 "lvnForm1098Details"
{
    ...
    fields
    {
        ...
        field(10; Type; Enum lvnForm1098EntryType)
        {
            DataClassification = CustomerContent;
            Caption = 'Type';
        }
        ...
        field(14; "Rule Line No."; Integer)
        {
            DataClassification = CustomerContent;
            Caption = 'Rule Line No.';
        }
        field(15; "Rule Description"; Text[50])
        {
            FieldClass = FlowField;
            Caption = 'Rule Description';
            CalcFormula = lookup(lvnForm1098ColRuleDetails.Description where("Box No." = field("Box No."), "Line No." = field("Rule Line No.")));
        }
