table 14135132 "lvnServicingWorksheet"
{
    ...
    fields
    {
        ...
        field(10; "Customer No."; Code[20]) { Caption = 'Customer No.'; Editable = false; FieldClass = FlowField; CalcFormula = lookup(lvnLoan."Borrower Customer No." where("No." = field("Loan No."))); }
        field(11; "Date Funded"; Date) { Caption = 'Date Funded'; Editable = false; FieldClass = FlowField; CalcFormula = lookup(lvnLoan."Date Funded" where("No." = field("Loan No."))); }
        field(12; "Date Sold"; Date) { Caption = 'Date Sold'; Editable = false; FieldClass = FlowField; CalcFormula = lookup(lvnLoan."Date Sold" where("No." = field("Loan No."))); }
        field(13; "First Payment Due"; Date) { Caption = 'First Payment Due'; Editable = false; FieldClass = FlowField; CalcFormula = lookup(lvnLoan."First Payment Due" where("No." = field("Loan No."))); }
        field(14; "First Payment Due To Investor"; Date) { Caption = 'First Payment Due to Investor'; Editable = false; FieldClass = FlowField; CalcFormula = lookup(lvnLoan."First Payment Due To Investor" where("No." = field("Loan No."))); }
        field(15; "Next Payment Date"; Date) { Caption = 'Next Payment Date'; Editable = false; FieldClass = FlowField; CalcFormula = lookup(lvnLoan."Next Payment Date" where("No." = field("Loan No."))); }
        field(16; "Borrower Name"; Text[100]) { Caption = 'Borrower Name'; Editable = false; FieldClass = FlowField; CalcFormula = lookup(lvnLoan."Search Name" where("No." = field("Loan No."))); }
