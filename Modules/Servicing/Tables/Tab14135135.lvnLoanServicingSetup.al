table 14135135 "lvnLoanServicingSetup"
{
    ...
    fields
    {
        ...
        field(35; "Interest Cost Center Option"; enum lvnServDimSelectionType) { Caption = 'Interest Cost Center Option'; DataClassification = CustomerContent; }
        field(36; "Principal Cost Center Option"; enum lvnServDimSelectionType) { Caption = 'Principal Cost Center Option'; DataClassification = CustomerContent; }
        ...
        field(56; "Late Fee Amount Rule"; enum lvnServicingLateFeeRule) { Caption = 'Late Fee Amount Rule'; DataClassification = CustomerContent; }
