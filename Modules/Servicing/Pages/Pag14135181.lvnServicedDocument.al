page 14135181 "lvnServicedDocument"
{
    ...
    layout
    {
        area(Content)
        {
            ...
            part(lvnServicedDocumentSubpage; lvnServicedDocumentSubpage)
            {
                Caption = 'Lines';
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(Print)
            {
                ...
                trigger OnAction()
                var
                    LoanDocumentView: Record lvnLoanDocument;
                    LoanDocumentReport: Report lvnLoanDocument;
                begin
