table 14135152 "lvnLoanNormalizedViewSetup"
{
    ...
    fields
    {
        ...
        field(1002; "Entries Count"; Integer) { Caption = 'Entries Count'; FieldClass = FlowField; CalcFormula = count(lvnLoanNormalizedView where("View Code" = field(Code))); Editable = false; }
    }
