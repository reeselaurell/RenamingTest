codeunit 14135117 "lvnSalesFileImportManagement"
{
    var
    ...
    begin
        ...
        repeat
            ...
            if GenJnlImportBuffer."Reason Code" <> '' then
                SalesLine.Validate(lvnReasonCode, GenJnlImportBuffer."Reason Code");
            SalesLine.lvnLoanNo := GenJnlImportBuffer."Loan No.";
