codeunit 14135116 "lvnPurchFileImportManagement"
{
    var
    ...
    procedure CreatePurchaseLines(var GenJnlImportBuffer: Record lvnGenJnlImportBuffer; DocumentType: enum lvnLoanDocumentType; DocumentNo: Code[20])
    var
    ...
    begin
        ...
        repeat
            ...
            if GenJnlImportBuffer."Reason Code" <> '' then
                PurchaseLine.Validate(lvnReasonCode, GenJnlImportBuffer."Reason Code");
            PurchaseLine.lvnLoanNo := GenJnlImportBuffer."Loan No.";
