table 14135126 "lvnFileImportSchema"
{
    ...
    fields
    {
        ...
        field(5; "File Import Type"; Enum lvnFileImportType) { Caption = 'Import Type'; DataClassification = CustomerContent; }
        ...
        field(20; "Dimension 1 Mapping Type"; enum lvnDimensionMappingType) { Caption = 'Dimension 1 Mapping Type'; DataClassification = CustomerContent; }
        field(21; "Dimension 2 Mapping Type"; enum lvnDimensionMappingType) { Caption = 'Dimension 2 Mapping Type'; DataClassification = CustomerContent; }
        field(22; "Dimension 3 Mapping Type"; enum lvnDimensionMappingType) { Caption = 'Dimension 3 Mapping Type'; DataClassification = CustomerContent; }
        field(23; "Dimension 4 Mapping Type"; enum lvnDimensionMappingType) { Caption = 'Dimension 4 Mapping Type'; DataClassification = CustomerContent; }
        field(24; "Dimension 5 Mapping Type"; enum lvnDimensionMappingType) { Caption = 'Dimension 5 Mapping Type'; DataClassification = CustomerContent; }
        field(25; "Dimension 6 Mapping Type"; enum lvnDimensionMappingType) { Caption = 'Dimension 6 Mapping Type'; DataClassification = CustomerContent; }
        field(26; "Dimension 7 Mapping Type"; enum lvnDimensionMappingType) { Caption = 'Dimension 7 Mapping Type'; DataClassification = CustomerContent; }
        field(27; "Dimension 8 Mapping Type"; enum lvnDimensionMappingType) { Caption = 'Dimension 8 Mapping Type'; DataClassification = CustomerContent; }
        ...
        field(50; "Dimension Validation Rule"; enum lvnDimensionValidationRule) { Caption = 'Dimension Validation Rule'; DataClassification = CustomerContent; }
        field(100; "Gen. Jnl. Account Type"; Enum lvnGenJnlAccountType) { Caption = 'Account Type'; DataClassification = CustomerContent; }
        field(101; "Account Mapping Type"; Enum lvnAccountMappingType) { Caption = 'Account Mapping Type'; DataClassification = CustomerContent; }
        ...
        field(105; "Gen. Jnl. Bal. Account Type"; Enum lvnGenJnlAccountType) { Caption = 'Bal. Account Type'; DataClassification = CustomerContent; }
        field(106; "Bal. Account Mapping Type"; Enum lvnAccountMappingType) { Caption = 'Bal. Account Mapping Type'; DataClassification = CustomerContent; }
        ...
        field(109; "Document Type"; Enum lvnGenJnlImportDocumentType) { Caption = 'Document Type'; DataClassification = CustomerContent; }
        field(110; "Document Type Option"; enum lvnImportDocumentTypeOption) { Caption = 'Document Type Option'; DataClassification = CustomerContent; }
        ...
        field(112; "Document No. Filling"; enum lvnGenJnlDocumentNoFilling) { Caption = 'Document No. Filling'; DataClassification = CustomerContent; }
        ...
        field(115; "Loan No. Validation Rule"; Enum lvnLoanNoValidationRule) { Caption = 'Loan No. Validation Rule'; DataClassification = CustomerContent; }
        field(116; "Applies-To Doc. Type"; enum lvnGenJnlImportDocumentType) { Caption = 'Applies-to Doc. Type'; DataClassification = CustomerContent; }
        field(117; "Bank Payment Type"; Enum lvnBankPaymentType) { Caption = 'Bank Payment Type'; DataClassification = CustomerContent; }
        field(118; "Recurring Method"; enum lvnRecurrencyMethod) { Caption = 'Recurring Method'; DataClassification = CustomerContent; }
        field(119; "Recurring Frequency"; DateFormula) { Caption = 'Recurring Frequency'; DataClassification = CustomerContent; }
        field(120; "Deposit Document Type"; enum lvnDepositDocumentType) { Caption = 'Deposit Document Type'; DataClassification = CustomerContent; }
    }
