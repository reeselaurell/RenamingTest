table 14135159 "lvnFlexibleImportSchemaLine"
{
    ...
    fields
    {
        ...
        field(12; "Bal. Account Type"; Enum lvnGenJnlAccountType)
        {
        ...
        field(15; "Reverse Amount"; Boolean)
        {
            Caption = 'Reverse Amount';
            DataClassification = CustomerContent;
        }
        field(16; "Custom Description"; Text[50])
        {
            Caption = 'Custom Description';
            DataClassification = CustomerContent;
        }
        field(17; "Validate From Hierarchy"; Boolean)
        {
            Caption = 'Validate From Hierarchy';
            DataClassification = CustomerContent;
        }
        field(20; "Dimension Validation Rule 1"; Enum lvnFlexImportDimValidationRule)
        {
            Caption = 'Dimension Validation Rule 1';
            DataClassification = CustomerContent;
        }
        field(21; "Dimension Validation Rule 2"; Enum lvnFlexImportDimValidationRule)
        {
            Caption = 'Dimension Validation Rule 2';
            DataClassification = CustomerContent;
        }
        field(22; "Dimension Validation Rule 3"; Enum lvnFlexImportDimValidationRule)
        {
            Caption = 'Dimension Validation Rule 3';
            DataClassification = CustomerContent;
        }
