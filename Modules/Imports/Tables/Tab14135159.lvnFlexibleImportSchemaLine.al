table 14135159 "lvnFlexibleImportSchemaLine"
{
    ...
    fields
    {
        field(1; "Schema Code"; Code[20]) { Caption = 'Schema Code'; DataClassification = CustomerContent; TableRelation = lvnFlexibleImportSchema.Code; }
        field(2; "Amount Column No."; Integer) { Caption = 'Amount Column No.'; DataClassification = CustomerContent; }
        field(10; "Account Type"; Enum lvnGenJnlAccountType) { Caption = 'Account Type'; DataClassification = CustomerContent; }
        ...
        field(12; "Bal. Account Type"; Enum lvnGenJnlAccountType) { Caption = 'Bal. Account Type'; DataClassification = CustomerContent; }
        ...
        field(20; "Dimension Validation Rule 1"; Enum lvnFlexImportDimValidationRule) { Caption = 'Dimension Validation Rule 1'; DataClassification = CustomerContent; }
        field(21; "Dimension Validation Rule 2"; Enum lvnFlexImportDimValidationRule) { Caption = 'Dimension Validation Rule 2'; DataClassification = CustomerContent; }
        field(22; "Dimension Validation Rule 3"; Enum lvnFlexImportDimValidationRule) { Caption = 'Dimension Validation Rule 3'; DataClassification = CustomerContent; }
        ...
        field(14135108; "Servicing Type"; enum lvnServicingType) { Caption = 'Servicing Type'; DataClassification = CustomerContent; }
    }
