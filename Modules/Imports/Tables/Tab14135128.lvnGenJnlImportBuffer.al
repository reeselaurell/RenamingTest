table 14135128 "lvnGenJnlImportBuffer"
{
    ...
    fields
    {
        ...
        field(10; "Account Type"; enum lvnGenJnlAccountType)
        {
        ...
        field(12; "Document Type"; Enum lvnGenJnlImportDocumentType)
        {
        ...
        field(17; "Bal. Account Type"; enum lvnGenJnlAccountType)
        {
        ...
        field(20; "Posting Group"; Code[20])
        {
        ...
        field(22; "Applies-To Doc. Type"; Enum lvnGenJnlImportDocumentType)
        {
        ...
        field(28; "Recurring Method"; enum lvnRecurrencyMethod)
        {
            Caption = 'Recurring Method';
            DataClassification = CustomerContent;
        }
        field(29; "Recurring Frequency"; DateFormula)
        {
            Caption = 'Recurring Frequency';
            DataClassification = CustomerContent;
        }
        field(30; "Bank Payment Type"; enum lvnBankPaymentType)
        {
            Caption = 'Bank Payment Type';
            DataClassification = CustomerContent;
        }
        field(31; "Depreciation Book Code"; Code[10])
        {
            Caption = 'Depreciation Book Code';
            DataClassification = CustomerContent;
        }
        field(32; "FA Posting Type"; Enum "Gen. Journal Line FA Posting Type")
        {
        ...
        field(90; "Global Dimension 1 Value"; Text[50])
        {
            Caption = 'Global Dimension 1 Value';
            DataClassification = CustomerContent;
        }
        field(91; "Global Dimension 2 Value"; Text[50])
        {
            Caption = 'Global Dimension 2 Value';
            DataClassification = CustomerContent;
        }
        field(92; "Shortcut Dimension 3 Value"; Text[50])
        {
            Caption = 'Shortcut Dimension 3 Value';
            DataClassification = CustomerContent;
        }
        field(93; "Shortcut Dimension 4 Value"; Text[50])
        {
            Caption = 'Shortcut Dimension 4 Value';
            DataClassification = CustomerContent;
        }
        field(94; "Shortcut Dimension 5 Value"; Text[50])
        {
            Caption = 'Shortcut Dimension 5 Value';
            DataClassification = CustomerContent;
        }
        field(95; "Shortcut Dimension 6 Value"; Text[50])
        {
            Caption = 'Shortcut Dimension 6 Value';
            DataClassification = CustomerContent;
        }
        field(96; "Shortcut Dimension 7 Value"; Text[50])
        {
            Caption = 'Shortcut Dimension 7 Value';
            DataClassification = CustomerContent;
        }
        field(97; "Shortcut Dimension 8 Value"; Text[50])
        {
            Caption = 'Shortcut Dimension 8 Value';
            DataClassification = CustomerContent;
        }
        field(98; "Account Value"; Text[50])
        {
            Caption = 'Account Value';
            DataClassification = CustomerContent;
        }
        field(99; "Bal. Account Value"; Text[50])
        {
            Caption = 'Bal. Account Value';
            DataClassification = CustomerContent;
        }
        field(100; "Business Unit Value"; Text[50])
        {
            Caption = 'Business Unit Code';
            DataClassification = CustomerContent;
        }
        field(101; "Flexible Line No."; Integer)
        {
            Caption = 'Flexible Line No.';
            DataClassification = CustomerContent;
        }
        field(102; "Use Dimension Hierarchy"; Boolean)
        {
        ...
        field(14135108; "Servicing Type"; enum lvnServicingType)
        {
