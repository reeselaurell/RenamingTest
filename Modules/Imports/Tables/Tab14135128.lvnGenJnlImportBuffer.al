table 14135128 "lvnGenJnlImportBuffer"
{
    ...
    fields
    {
        ...
        field(12; "Document Type"; Enum lvnGenJnlImportDocumentType) { Caption = 'Document Type'; DataClassification = CustomerContent; }
        ...
        field(17; "Bal. Account Type"; enum lvnGenJnlAccountType) { Caption = 'Bal. Account Type'; DataClassification = CustomerContent; }
        ...
        field(22; "Applies-To Doc. Type"; Enum lvnGenJnlImportDocumentType) { Caption = 'Applies-to Doc. Type'; DataClassification = CustomerContent; }
        ...
        field(28; "Recurring Method"; enum lvnRecurrencyMethod) { Caption = 'Recurring Method'; DataClassification = CustomerContent; }
        field(29; "Recurring Frequency"; DateFormula) { Caption = 'Recurring Frequency'; DataClassification = CustomerContent; }
        field(30; "Bank Payment Type"; enum lvnBankPaymentType) { Caption = 'Bank Payment Type'; DataClassification = CustomerContent; }
