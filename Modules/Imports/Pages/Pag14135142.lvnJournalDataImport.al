page 14135142 "lvnJournalDataImport"
{
    PageType = List;
    SourceTable = lvnGenJnlImportBuffer;
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field("Global Dimension 1 Value"; Rec."Global Dimension 1 Value")
                {
                    ApplicationArea = All;
                    Visible = false;
                }
                field("Global Dimension 2 Value"; Rec."Global Dimension 2 Value")
                {
                    ApplicationArea = All;
                    Visible = false;
                }
                ...
                field("Bal. Account Value"; Rec."Bal. Account Value")
                {
                    ApplicationArea = All;
                    Visible = false;
                }
        ...
        area(FactBoxes)
        {
            part(ImportBufferErrors; lvnImportBufferErrors)
            {
                Caption = 'Errors';
                ApplicationArea = All;
