table 14135137 "lvnQuickPayBuffer"
{
    ...
    fields
    {
        ...
        field(70; "Payment Method Code"; Code[10])
        {
        ...
        field(71; "Loan No."; Code[20])
        {
            Caption = 'Loan No.';
            DataClassification = CustomerContent;
        }
        field(80; "Applies-to ID"; Code[50])
        {
