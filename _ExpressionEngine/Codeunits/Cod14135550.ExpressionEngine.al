codeunit 14135550 lvngExpressionEngine
{
    var
    ...
    local procedure ResolveCondition(LeftHand: Text; Comparison: Enum lvngComparison; RightHand: Text; var ValueBuffer: Record lvngExpressionValueBuffer): Boolean
    var
        DecimalLeft: Decimal;
    ...
    local procedure CalculateOrReturnValue(Expression: Text; var ValueBuffer: Record lvngExpressionValueBuffer): Text
    var
        FieldName: Text;
    begin
    ...
    local procedure ResolveVariables(Expression: Text; var ValueBuffer: Record lvngExpressionValueBuffer) Result: Text
    var
        Idx: Integer;
        FieldName: Text;
    begin
    ...
    local procedure GetValue(FieldName: Text; var ValueBuffer: Record lvngExpressionValueBuffer; WrapLiterals: Boolean): Text
    begin
        ValueBuffer.Reset();
    ...
    local procedure CalculateValue(Expression: Text; var ValueBuffer: Record lvngExpressionValueBuffer) Result: Text
    var
        Test: Text;
    begin
        if Expression = '' then
    ...
    local procedure CalculateDecimalValue(Expression: Text; var ValueBuffer: Record lvngExpressionValueBuffer): Text
    var
        i: Integer;
        OpenIdx: Integer;
        ExpLen: Integer;
