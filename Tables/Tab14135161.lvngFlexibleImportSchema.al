table 14135161 lvngFlexibleImportSchema
{
    ...
    fields
    {
        ...
        field(41; "Dimension 1 Code Column No."; Integer) { Caption = 'Dimension 1 Code Column No.'; DataClassification = CustomerContent; BlankZero = true; }
        field(42; "Dimension 2 Code Column No."; Integer) { Caption = 'Dimension 2 Code Column No.'; DataClassification = CustomerContent; BlankZero = true; }
        field(43; "Dimension 3 Code Column No."; Integer) { Caption = 'Dimension 3 Code Column No.'; DataClassification = CustomerContent; BlankZero = true; }
        field(44; "Dimension 4 Code Column No."; Integer) { Caption = 'Dimension 4 Code Column No.'; DataClassification = CustomerContent; BlankZero = true; }
        field(45; "Dimension 5 Code Column No."; Integer) { Caption = 'Dimension 5 Code Column No.'; DataClassification = CustomerContent; BlankZero = true; }
        field(46; "Dimension 6 Code Column No."; Integer) { Caption = 'Dimension 6 Code Column No.'; DataClassification = CustomerContent; BlankZero = true; }
        field(47; "Dimension 7 Code Column No."; Integer) { Caption = 'Dimension 7 Code Column No.'; DataClassification = CustomerContent; BlankZero = true; }
        field(48; "Dimension 8 Code Column No."; Integer) { Caption = 'Dimension 8 Code Column No.'; DataClassification = CustomerContent; BlankZero = true; }
