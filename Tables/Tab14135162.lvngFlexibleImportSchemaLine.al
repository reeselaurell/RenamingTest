table 14135162 lvngFlexibleImportSchemaLine
{
    ...
    fields
    {
        ...
        field(14; "Dimension Validation Rule"; Enum lvngFlexImportDimValidationRule) { Caption = 'Dimension Validation Rule'; DataClassification = CustomerContent; }
