table 14135107 "lvngLoanJournalLine"
{
    ...
    fields
    {
        ...
        field(5; "Loan No."; Code[20]) { DataClassification = CustomerContent; }
        ...
        field(16; "Borrower Customer No."; Code[20]) { DataClassification = CustomerContent; TableRelation = Customer."No."; }
        ...
        field(200; "Borrower Address"; Text[50]) { DataClassification = CustomerContent; }
        field(201; "Borrower Address 2"; Text[50]) { DataClassification = CustomerContent; }
        field(202; "Borrower City"; Text[30]) { DataClassification = CustomerContent; }
        field(203; "Borrower State"; Text[30]) { DataClassification = CustomerContent; }
        field(204; "Borrower ZIP Code"; Code[20]) { DataClassification = CustomerContent; }
        field(210; "Co-Borrower Address"; Text[50]) { DataClassification = CustomerContent; }
        field(211; lvngCoBorrowerAddress2; Text[50]) { DataClassification = CustomerContent; }
        field(212; "Co-Borrower City"; Text[30]) { DataClassification = CustomerContent; }
        field(213; "Co-Borrower State"; Text[30]) { DataClassification = CustomerContent; }
        field(214; "Co-Borrower ZIP Code"; Code[20]) { DataClassification = CustomerContent; }
        field(220; "Property Address"; Text[50]) { DataClassification = CustomerContent; }
        field(221; "Property Address 2"; Text[50]) { DataClassification = CustomerContent; }
        field(222; "Property City"; Text[30]) { DataClassification = CustomerContent; }
        field(223; "Property State"; Text[30]) { DataClassification = CustomerContent; }
        field(224; "Property ZIP Code"; Code[20]) { DataClassification = CustomerContent; }
        field(230; "Mailing Address"; Text[50]) { DataClassification = CustomerContent; }
        field(231; "Mailing Address 2"; Text[50]) { DataClassification = CustomerContent; }
        field(232; "Mailing City"; Text[30]) { DataClassification = CustomerContent; }
        field(233; "Mailing State"; Text[30]) { DataClassification = CustomerContent; }
        field(234; "Mailing ZIP Code"; Code[20]) { DataClassification = CustomerContent; }
        ...
        field(5000; "Processing Schema Code"; Code[20]) { DataClassification = CustomerContent; TableRelation = lvngLoanProcessingSchema.Code; }
        field(5001; "Reason Code"; Code[10]) { DataClassification = CustomerContent; TableRelation = "Reason Code".Code; }
        field(10000; "Calculated Document Amount"; Decimal) { Caption = 'Document Amount'; DataClassification = CustomerContent; }
        field(50000; "Error Exists"; Boolean) { FieldClass = FlowField; CalcFormula = exist (lvngLoanImportErrorLine where("Loan Journal Batch Code" = field("Loan Journal Batch Code"), "Line No." = field("Line No."))); }
    }
