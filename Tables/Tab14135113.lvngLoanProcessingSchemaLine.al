table 14135113 lvngLoanProcessingSchemaLine
{
    ...
    fields
    {
        field(1; "Processing Code"; Code[20]) { Caption = 'Processing Code'; DataClassification = CustomerContent; TableRelation = lvngLoanProcessingSchema; NotBlank = true; }
        ...
        field(14; "Account Type"; enum lvngLoanAccountType) { Caption = 'Account Type'; DataClassification = CustomerContent; }
