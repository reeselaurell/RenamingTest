table 14135131 lvngServiceLine
{
    ...
    fields
    {
        ...
        field(2; "Document No."; Code[20]) { Caption = 'Document No.'; TableRelation = lvngServiceHeader."No." where("Servicing Document Type" = field("Servicing Document Type")); DataClassification = CustomerContent; }
        ...
        field(14; "Servicing Type"; enum lvngServicingType) { Caption = 'Servicing Type'; DataClassification = CustomerContent; }
