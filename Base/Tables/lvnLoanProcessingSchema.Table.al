table 14135111 "lvnLoanProcessingSchema"
{
    ...
    fields
    {
        ...
        field(12; "Global Schema"; Boolean)
        {
            Caption = 'Global Schema';
            DataClassification = CustomerContent;
        }
        field(13; "Use Global Schema Code"; Code[20])
        {
            Caption = 'Use Global Schema Code';
            DataClassification = CustomerContent;
            TableRelation = lvnLoanProcessingSchema.Code where("Global Schema" = const(true));
        }
        field(14; "Document Type Option"; Enum lvnDocumentTypeOption)
        {
            Caption = 'Document Type Option';
            DataClassification = CustomerContent;
        }
        field(15; "External Document No. Field"; Integer)
        {
            Caption = 'External Document No. Field';
            DataClassification = CustomerContent;
