table 14135100 "lvnLoanVisionSetup"
{
    ...
    fields
    {
        ...
        field(401; "Level 1"; enum lvnHierarchyLevels) { Caption = 'Level 1'; DataClassification = CustomerContent; }
        field(402; "Level 2"; enum lvnHierarchyLevels) { Caption = 'Level 2'; DataClassification = CustomerContent; }
        field(403; "Level 3"; enum lvnHierarchyLevels) { Caption = 'Level 3'; DataClassification = CustomerContent; }
        field(404; "Level 4"; enum lvnHierarchyLevels) { Caption = 'Level 4'; DataClassification = CustomerContent; }
        field(405; "Level 5"; enum lvnHierarchyLevels) { Caption = 'Level 5'; DataClassification = CustomerContent; }
        field(500; "Last Analysis Entry No."; Integer) { Caption = 'Last Analysis Entry No.'; DataClassification = CustomerContent; }
        field(862; "Borrower E-Mail Field No."; Integer) { Caption = 'Borrower E-Mail Field No.'; DataClassification = CustomerContent; TableRelation = lvnLoanFieldsConfiguration."Field No." where("Value Type" = const(Text)); }
