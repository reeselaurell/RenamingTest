table 14135115 lvngLoanDocumentLine
{
    ...
    fields
    {
        field(1; "Transaction Type"; enum lvngLoanTransactionType) { Caption = 'Document Type'; DataClassification = CustomerContent; }
        field(2; "Document No."; Code[20]) { Caption = 'Document No.'; DataClassification = CustomerContent; TableRelation = lvngLoanDocument."Document No." where("Transaction Type" = field("Transaction Type")); }
        field(3; "Line No."; Integer) { Caption = 'Line No.'; DataClassification = CustomerContent; }
        field(10; "Account Type"; enum lvngLoanAccountType) { Caption = 'Account Type'; DataClassification = CustomerContent; }
        ...
        field(1000; "Processing Schema Code"; code[20]) { Caption = 'Processing Schema Code'; DataClassification = CustomerContent; TableRelation = lvngLoanProcessingSchema.Code; }
        field(1001; "Processing Schema Line No."; Integer) { Caption = 'Processing Schema Line No.'; DataClassification = CustomerContent; TableRelation = lvngLoanProcessingSchemaline."Line No." where("Processing Code" = field("Processing Schema Code")); }
