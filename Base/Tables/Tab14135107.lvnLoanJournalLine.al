table 14135107 "lvnLoanJournalLine"
{
    ...
    fields
    {
        field(1; "Loan Journal Batch Code"; Code[20]) { Caption = 'Batch Code'; DataClassification = CustomerContent; TableRelation = lvnLoanJournalBatch; }
        ...
        field(211; "Co-Borrower Address 2"; Text[50]) { Caption = 'lvnCoBorrowerAddress2'; DataClassification = CustomerContent; }
        ...
        field(5000; "Processing Schema Code"; Code[20]) { Caption = 'Processing Schema Code'; DataClassification = CustomerContent; TableRelation = lvnLoanProcessingSchema.Code; }
        ...
        field(50000; "Error Exists"; Boolean) { Caption = 'Error Exists'; FieldClass = FlowField; CalcFormula = exist(lvnLoanImportErrorLine where("Loan Journal Batch Code" = field("Loan Journal Batch Code"), "Line No." = field("Line No."))); }
    }
