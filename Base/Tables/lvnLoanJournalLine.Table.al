table 14135107 "lvnLoanJournalLine"
{
    ...
    fields
    {
        ...
        field(200; "Borrower Address"; Text[50])
        {
            Caption = 'Borrower Address';
            DataClassification = CustomerContent;
        }
        field(201; "Borrower Address 2"; Text[50])
        {
            Caption = 'Borrower Address 2';
            DataClassification = CustomerContent;
        }
        field(202; "Borrower City"; Text[30])
        {
            Caption = 'Borrower City';
            DataClassification = CustomerContent;
        }
        field(203; "Borrower State"; Text[30])
        {
            Caption = 'Borrower State';
            DataClassification = CustomerContent;
        }
        field(204; "Borrower ZIP Code"; Code[20])
        {
            Caption = 'Borrower ZIP Code';
            DataClassification = CustomerContent;
        }
        field(210; "Co-Borrower Address"; Text[50])
        {
            Caption = 'Co-Borrower Address';
            DataClassification = CustomerContent;
        }
        field(211; "Co-Borrower Address 2"; Text[50])
        {
            Caption = 'lvnCoBorrowerAddress2';
            DataClassification = CustomerContent;
        }
        field(212; "Co-Borrower City"; Text[30])
        {
            Caption = 'Co-Borrower City';
            DataClassification = CustomerContent;
        }
        field(213; "Co-Borrower State"; Text[30])
        {
            Caption = 'Co-Borrower State';
            DataClassification = CustomerContent;
        }
        field(214; "Co-Borrower ZIP Code"; Code[20])
        {
            Caption = 'Co-Borrower ZIP Code';
            DataClassification = CustomerContent;
        }
        field(220; "Property Address"; Text[50])
        {
            Caption = 'Property Address';
            DataClassification = CustomerContent;
        }
        field(221; "Property Address 2"; Text[50])
        {
            Caption = 'Property Address 2';
            DataClassification = CustomerContent;
        }
        field(222; "Property City"; Text[30])
        {
            Caption = 'Property City';
            DataClassification = CustomerContent;
        }
        field(223; "Property State"; Text[30])
        {
            Caption = 'Property State';
            DataClassification = CustomerContent;
        }
        field(224; "Property ZIP Code"; Code[20])
        {
            Caption = 'Property ZIP Code';
            DataClassification = CustomerContent;
        }
        field(230; "Mailing Address"; Text[50])
        {
            Caption = 'Mailing Address';
            DataClassification = CustomerContent;
        }
        field(231; "Mailing Address 2"; Text[50])
        {
            Caption = 'Mailing Address 2';
            DataClassification = CustomerContent;
        }
        field(232; "Mailing City"; Text[30])
        {
            Caption = 'Mailing City';
            DataClassification = CustomerContent;
        }
        field(233; "Mailing State"; Text[30])
        {
            Caption = 'Mailing State';
            DataClassification = CustomerContent;
        }
        field(234; "Mailing ZIP Code"; Code[20])
        {
        ...
        field(5000; "Processing Schema Code"; Code[20])
        {
            Caption = 'Processing Schema Code';
            DataClassification = CustomerContent;
            TableRelation = lvnLoanProcessingSchema.Code;
        }
        field(5001; "Reason Code"; Code[10])
        {
            Caption = 'Reason Code';
            DataClassification = CustomerContent;
            TableRelation = "Reason Code".Code;
        }
        field(10000; "Calculated Document Amount"; Decimal)
        {
        ...
        field(10001; "Error Exists"; Boolean)
        {
            ...
            CalcFormula = exist(lvnLoanImportErrorLine where("Loan Journal Batch Code" = field("Loan Journal Batch Code"), "Line No." = field("Line No.")));
        }
    }
