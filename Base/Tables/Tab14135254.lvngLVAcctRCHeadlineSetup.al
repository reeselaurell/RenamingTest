table 14135254 lvngLVAcctRCHeadlineSetup
{
    ...
    fields
    {
        ...
        field(10; "Branch Performace Date Range"; Enum lvngLVAcctDateRange) { Caption = 'Branch Performance Date Range'; DataClassification = CustomerContent; }
        field(11; "LO Performace Date Range"; Enum lvngLVAcctDateRange) { Caption = 'LO Performance Date Range'; DataClassification = CustomerContent; }
