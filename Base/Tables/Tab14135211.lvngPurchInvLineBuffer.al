table 14135211 lvngPurchInvLineBuffer
{
    ...
    fields
    {
        field(1; "Document No."; Code[20]) { Caption = 'Document No.'; DataClassification = CustomerContent; TableRelation = lvngPurchInvHdrBuffer."No."; }
