table 14135120 "lvnLoanUpdateSchema"
{
    ...
    fields
    {
        ...
        field(2; "Import Field Type"; Enum lvnImportFieldType) { Caption = 'Field Type'; DataClassification = CustomerContent; }
        field(3; "Field No."; Integer) { Caption = 'Field No.'; DataClassification = CustomerContent; }
        field(10; "Field Update Option"; enum lvnFieldUpdateCondition) { Caption = 'Update Option'; DataClassification = CustomerContent; }
    }
