table 14135211 "lvnPurchInvLineBuffer"
{
    ...
    fields
    {
        field(1; "Document No."; Code[20])
        {
            Caption = 'Document No.';
            DataClassification = CustomerContent;
            TableRelation = lvnPurchInvHdrBuffer."No.";
        }
        ...
        field(22; "Business Unit Code"; Code[20])
        {
        ...
        field(24; Type; Enum "Purchase Line Type")
        {
            Caption = 'Type';
            DataClassification = CustomerContent;
        }
        field(25; "Loan No. Validation"; Enum lvnLoanNoValidationRule)
        {
            Caption = 'Loan No. Validation';
            DataClassification = CustomerContent;
        }
    }
