table 14135211 "lvnPurchInvLineBuffer"
{
    ...
    fields
    {
        field(1; "Document No."; Code[20]) { Caption = 'Document No.'; DataClassification = CustomerContent; TableRelation = lvnPurchInvHdrBuffer."No."; }
        ...
        field(11; "Direct Unit Cost"; Decimal) { Caption = 'Direct Unit Cost'; DataClassification = CustomerContent; }
        ...
        field(23; "Loan No."; Code[20]) { Caption = 'Loan No.'; DataClassification = CustomerContent; TableRelation = lvnLoan; }
        field(24; Type; Enum "Purchase Line Type") { Caption = 'Type'; DataClassification = CustomerContent; }
        field(25; "Loan No. Validation"; Enum lvnLoanNoValidationRule) { Caption = 'Loan No. Validation'; DataClassification = CustomerContent; }
    }
