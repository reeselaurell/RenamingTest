table 14135106 "lvnLoanAddress"
{
    ...
    fields
    {
        field(1; "Loan No."; Code[20]) { Caption = 'Loan No.'; DataClassification = CustomerContent; TableRelation = lvnLoan; }
        field(2; "Address Type"; Enum lvnAddressType) { Caption = 'Address Type'; DataClassification = CustomerContent; }
