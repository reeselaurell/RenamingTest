table 14135113 "lvnLoanProcessingSchemaLine"
{
    ...
    fields
    {
        field(1; "Processing Code"; Code[20]) { Caption = 'Processing Code'; DataClassification = CustomerContent; TableRelation = lvnLoanProcessingSchema; NotBlank = true; }
        field(2; "Line No."; Integer) { Caption = 'Line No.'; DataClassification = CustomerContent; }
        field(10; "Processing Source Type"; Enum lvnProcessingSourceType) { Caption = 'Source Type'; DataClassification = CustomerContent; }
        ...
        field(14; "Account Type"; enum lvnLoanAccountType) { Caption = 'Account Type'; DataClassification = CustomerContent; }
        field(15; "Account No."; code[20]) { Caption = 'Account No.'; DataClassification = CustomerContent; }
        ...
        field(18; "Tag Code"; Code[10]) { Caption = 'Tag Code'; DataClassification = CustomerContent; }
