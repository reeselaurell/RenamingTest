table 14135134 "lvnGLEntryBuffer"
{
    ...
    fields
    {
        ...
        field(21; "Date Sold"; Date)
        {
            Caption = 'Date Funded';
            DataClassification = CustomerContent;
        }
        field(22; "Loan Search Name"; Code[100])
        {
            Caption = 'Loan Search Name';
            DataClassification = CustomerContent;
        }
        field(23; "Source Code"; Code[20])
        {
            Caption = 'Source Code';
            DataClassification = CustomerContent;
        }
        field(30; "Investor Name"; Text[100])
        {
        ...
        field(26; "Reference No."; code[20])
        {
            Caption = 'Reference No.';
            DataClassification = CustomerContent;
        }
        field(204; "Payment Due Date"; Date)
        {
            Caption = 'Payment Due Date';
            DataClassification = CustomerContent;
        }
        field(206; "Document No."; Code[20])
        {
            Caption = 'Document No.';
            DataClassification = CustomerContent;
        }
