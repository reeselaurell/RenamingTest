table 14135111 "lvnLoanProcessingSchema"
{
    Caption = 'Loan Processing Schema';
    DataClassification = CustomerContent;
    LookupPageId = lvnLoanProcessingSchema;
    ...
    fields
    {
        ...
        field(13; "Use Global Schema Code"; Code[20]) { Caption = 'Use Global Schema Code'; DataClassification = CustomerContent; TableRelation = lvnLoanProcessingSchema.Code where("Global Schema" = const(true)); }
        field(14; "Document Type Option"; Enum lvnDocumentTypeOption) { Caption = 'Document Type Option'; DataClassification = CustomerContent; }
        field(15; "External Document No. Field"; Integer) { Caption = 'External Document No. Field'; DataClassification = CustomerContent; TableRelation = lvnLoanFieldsConfiguration."Field No."; }
        ...
        field(1000; "Dimension 1 Rule"; enum lvnProcessingDimensionRule) { Caption = 'Dimension 1 Rule'; CaptionClass = GetRuleCaptionString(1); DataClassification = CustomerContent; }
        field(1001; "Dimension 2 Rule"; enum lvnProcessingDimensionRule) { Caption = 'Dimension 2 Rule'; CaptionClass = GetRuleCaptionString(2); DataClassification = CustomerContent; }
        field(1002; "Dimension 3 Rule"; enum lvnProcessingDimensionRule) { Caption = 'Dimension 3 Rule'; CaptionClass = GetRuleCaptionString(3); DataClassification = CustomerContent; }
        field(1003; "Dimension 4 Rule"; enum lvnProcessingDimensionRule) { Caption = 'Dimension 4 Rule'; CaptionClass = GetRuleCaptionString(4); DataClassification = CustomerContent; }
        field(1004; "Dimension 5 Rule"; enum lvnProcessingDimensionRule) { Caption = 'Dimension 5 Rule'; CaptionClass = GetRuleCaptionString(5); DataClassification = CustomerContent; }
        field(1005; "Dimension 6 Rule"; enum lvnProcessingDimensionRule) { Caption = 'Dimension 6 Rule'; CaptionClass = GetRuleCaptionString(6); DataClassification = CustomerContent; }
        field(1006; "Dimension 7 Rule"; enum lvnProcessingDimensionRule) { Caption = 'Dimension 7 Rule'; CaptionClass = GetRuleCaptionString(7); DataClassification = CustomerContent; }
        field(1007; "Dimension 8 Rule"; enum lvnProcessingDimensionRule) { Caption = 'Dimension 8 Rule'; CaptionClass = GetRuleCaptionString(8); DataClassification = CustomerContent; }
        field(1008; "Business Unit Rule"; enum lvnProcessingDimensionRule) { Caption = 'Business Unit Rule'; DataClassification = CustomerContent; }
    }
