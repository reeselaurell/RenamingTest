table 14135214 "lvnSalesInvLineBuffer"
{
    ...
    fields
    {
        field(1; "Document No."; Code[20]) { Caption = 'Document No.'; DataClassification = CustomerContent; TableRelation = lvnSalesInvHdrBuffer."No."; }
