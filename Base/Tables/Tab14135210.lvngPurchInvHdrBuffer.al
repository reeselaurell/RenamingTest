table 14135210 lvngPurchInvHdrBuffer
{
    ...
    fields
    {
        ...
        field(16; "Buy From Vendor No."; Code[20]) { Caption = 'Buy From Vendor No.'; DataClassification = CustomerContent; TableRelation = Vendor; }
    }
