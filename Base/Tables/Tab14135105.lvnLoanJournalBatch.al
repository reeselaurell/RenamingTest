table 14135105 "lvnLoanJournalBatch"
{
    ...
    fields
    {
        ...
        field(11; "Loan Journal Type"; enum lvnLoanJournalBatchType) { Caption = 'Journal Type'; DataClassification = CustomerContent; }
        ...
        field(13; "Def. Processing Schema Code"; Code[20]) { Caption = 'Default Processing Schema Code'; DataClassification = CustomerContent; TableRelation = lvnLoanProcessingSchema; }
        field(14; "Dimension Import Rule"; enum lvnDimensionImportRule) { Caption = 'Dimension Import Rule'; DataClassification = CustomerContent; }
        field(15; "Map Dimensions Using Hierachy"; Boolean) { Caption = 'Map Dimensions Using Hierachy'; DataClassification = CustomerContent; }
        field(16; "Dimension Hierarchy Date"; enum lvnLoanDateType) { Caption = 'Dimension Mapping Hierarchy Date'; DataClassification = CustomerContent; }
        ...
        field(50; "Loan Card Update Option"; Enum lvnLoanCardUpdateOption) { Caption = 'Loan Card Update Option'; DataClassification = CustomerContent; }
    }
