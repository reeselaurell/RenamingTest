codeunit 14135250 lvngPurchInvoiceImportMgmt
{
    ...
    procedure CreateInvoices(var PurchHeaderBuffer: Record lvngPurchInvHdrBuffer; var PurchLineBuffer: Record lvngPurchInvLineBuffer; Post: Boolean)
    var
    ...
    procedure ValidateHeaderEntries(var PurchInvJnlError: Record lvngInvoiceErrorDetail; var PurchInvHdrBuffer: Record lvngPurchInvHdrBuffer)
    var
    ...
    procedure ValidateLineEntries(var PurchInvJnlError: Record lvngInvoiceErrorDetail; var PurchInvLineBuffer: Record lvngPurchInvLineBuffer)
    var
    ...
    local procedure AddErrorLine(var PurchInvJnlError: Record lvngInvoiceErrorDetail; DocumentNo: Code[20]; isHeader: Boolean; LineNo: Integer; ErrorTxt: Text)
    var
        ErrorNo: Integer;
    begin
    ...
    procedure GroupLines(var pPurchInvImportHdr: Record lvngPurchInvHdrBuffer; var pPurchInvImportLine: Record lvngPurchInvLineBuffer)
    var
        TotalAmount: Decimal;
