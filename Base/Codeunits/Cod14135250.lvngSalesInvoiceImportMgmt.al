codeunit 14135251 lvngSalesInvoiceImportMgmt
{
    ...
    procedure CreateInvoices(var SalesHeaderBuffer: Record lvngSalesInvHdrBuffer; var SalesLineBuffer: Record lvngSalesInvLineBuffer; Post: Boolean)
    var
            ...
            repeat
                ...
                if SalesLineBuffer.FindSet() then
                    repeat
                        ...
                        SalesLine.Validate(lvngLoanNo, SalesLineBuffer."Loan No.");
    ...
    procedure ValidateHeaderEntries(var SalesInvJnlError: Record lvngInvoiceErrorDetail; var SalesInvHdrBuffer: Record lvngSalesInvHdrBuffer)
    var
    ...
    procedure ValidateLineEntries(var SalesInvJnlError: Record lvngInvoiceErrorDetail; var SalesInvLineBuffer: Record lvngSalesInvLineBuffer)
    var
    ...
    local procedure AddErrorLine(var SalesInvJnlError: Record lvngInvoiceErrorDetail; DocumentNo: Code[20]; isHeader: Boolean; LineNo: Integer; ErrorTxt: Text)
    var
        ErrorNo: Integer;
    begin
    ...
    procedure GroupLines(var pSalesInvImportHdr: Record lvngSalesInvHdrBuffer; var pSalesInvImportLine: Record lvngSalesInvLineBuffer)
    var
        TotalAmount: Decimal;
