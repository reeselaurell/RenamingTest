codeunit 14135104 "lvnDimensionsManagement"
{
    var
    ...
    procedure GetHierarchyDimensionNo(HierarchyLevels: Enum lvnHierarchyLevels): Integer;
    begin
    ...
    procedure FillDimensionsFromTable(Loan: Record lvnLoan; var DimensionCodes: array[8] of Code[20])
    begin
