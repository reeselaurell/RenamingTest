codeunit 14135106 "lvnLoanManagement"
{
    var
    ...
    var
        LoanNoMatchPattern: Record lvnLoanNoMatchPattern;
    begin
    ...
    procedure LoanNumberMatch(LoanNo: Code[20]; LoanNoMatchPattern: Record lvnLoanNoMatchPattern): Boolean
    var
    ...
    var
        ...
        TempLoanUpdateSchema: Record lvnLoanUpdateSchema temporary;
    ...
    procedure EvaluateLoanFieldsValue(var LoanValue: Record lvnLoanValue; FillBuffer: Boolean)
    begin
        ...
        if Page.RunModal(0, LoanImportSchema) = Action::LookupOK then begin
            ...
            if LoanImportSchemaLine.FindSet() then
                repeat
                    ...
                    LoanUpdateSchema."Field Update Option" := LoanUpdateSchema."Field Update Option"::lvnAlways;
    ...
    procedure GetCoBorrowerName(lvnLoan: Record lvnLoan): Text
    begin
        exit(GetFirstLastMiddleName(lvnLoan."Co-Borrower First Name", lvnLoan."Co-Borrower Last Name", lvnLoan."Co-Borrower Last Name"));
    end;
