tableextension 14135108 "lvnSalesLine" extends "Sales Line"
{
    fields
    {
        field(14135100; lvnLoanNo; Code[20]) { Caption = 'Loan No.'; DataClassification = CustomerContent; TableRelation = lvnLoan; }
        field(14135101; lvnServicingType; enum lvnServicingType) { Caption = 'Servicing Type'; DataClassification = CustomerContent; }
        ...
        field(14135106; lvnDeliveryState; Code[20]) { Caption = 'Delivery State'; DataClassification = CustomerContent; TableRelation = lvnState; }
        field(14135107; lvnUseSalesTax; Boolean) { Caption = 'Use Sales Tax'; DataClassification = CustomerContent; }
