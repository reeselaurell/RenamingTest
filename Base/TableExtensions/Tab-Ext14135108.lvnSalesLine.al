tableextension 14135108 "lvnSalesLine" extends "Sales Line"
{
    fields
    {
        ...
        field(14135104; lvnShortcutDimension1Name; Text[30])
        {
        ...
        field(14135105; lvnShortcutDimension2Name; Text[30])
        {
        ...
        field(14135106; lvnDeliveryState; Code[20])
        {
            Caption = 'Delivery State';
            DataClassification = CustomerContent;
            TableRelation = lvnState;
        }
        field(14135107; lvnUseSalesTax; Boolean)
        {
