tableextension 14135102 "lvnDimensionValue" extends "Dimension Value"
{
    fields
    {
        field(14135100; lvnAdditionalCode; Code[50]) { Caption = 'Additional Code'; DataClassification = CustomerContent; }
        field(14135101; lvnFirstName; Text[50]) { Caption = 'First Name'; DataClassification = CustomerContent; }
        field(14135102; lvnMiddleName; Text[30]) { Caption = 'Middle Name'; DataClassification = CustomerContent; }
        field(14135103; lvnLastName; Text[50]) { Caption = 'Last Name'; DataClassification = CustomerContent; }
    }
