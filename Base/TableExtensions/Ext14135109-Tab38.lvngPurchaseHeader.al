tableextension 14135109 lvngPurchaseHeader extends "Purchase Header"
{
    fields
    {
        ...
        field(14135102; lvngTotalAmount; Decimal) { Caption = 'Total Amount'; FieldClass = FlowField; CalcFormula = sum ("Purchase Line"."Direct Unit Cost" where("Document Type" = field("Document Type"), "Document No." = field("No."), Type = filter(<> ''))); Editable = false; }
