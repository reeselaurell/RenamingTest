tableextension 14135105 "lvnVendor" extends Vendor
{
    fields
    {
        field(14135100; lvnLegalName; Text[100])
        {
            Caption = 'Legal Name';
            DataClassification = CustomerContent;
        }
        field(14135101; lvnLegalAddress; Text[50])
        {
            Caption = 'Legal Address';
            DataClassification = CustomerContent;
        }
        field(14135102; lvnLegalAddress2; Text[50])
        {
            Caption = 'Legal Address 2';
            DataClassification = CustomerContent;
        }
        field(14135103; lvnLegalCity; Text[30])
        {
            Caption = 'Legal City';
            DataClassification = CustomerContent;
        }
        field(14135104; lvnLegalState; Text[30])
        {
            Caption = 'Legal State';
            DataClassification = CustomerContent;
        }
        field(14135105; lvnLegalZIPCode; Code[20])
        {
