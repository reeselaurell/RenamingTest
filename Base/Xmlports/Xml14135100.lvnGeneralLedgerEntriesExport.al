xmlport 14135100 "lvnGeneralLedgerEntriesExport"
{
    Direction = Export;
        ...
        textelement(Root)
        {
            tableelement(Header; Integer)
            {
                ...
                textelement(EntryDateCapt)
                {
                    trigger OnBeforePassVariable()
                    begin
                        EntryDateCapt := GLEntry.FieldCaption(lvnEntryDate);
                    end;
                }
                ...
                textelement(LoanNoCapt)
                {
                    trigger OnBeforePassVariable()
                    begin
                        LoanNoCapt := GLEntry.FieldCaption(lvnLoanNo);
                    end;
                }
                ...
                textelement(SourceNameCapt)
                {
                    trigger OnBeforePassVariable()
                    begin
                        SourceNameCapt := GLEntry.FieldCaption(lvnSourceName);
                    end;
                }
