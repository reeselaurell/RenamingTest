report 14135160 lvngLoanProfitability
{
        ...
        dataitem(Loan; lvngLoan)
        {
            ...
            dataitem(DataSetValues; Integer)
            {
                ...
                begin
                    ...
                    CalculatedValue := 0;
                    GLAccount.Reset();
                    GLAccount.SetRange(lvngReportingAccountName, TempDataBuffer."Raw Value");
                    GLAccount.FindSet();
                    repeat
    ...
    var
        ...
        TempDataBuffer: Record lvngLoanLevelValueBuffer temporary;
        ...
        ReportingType: Enum lvngLoanProfitReportingType;
        [InDataSet]
    ...
    begin
        ...
        if GLAccount.FindSet() then
            repeat
                TempDataBuffer.Reset();
                TempDataBuffer.SetRange("Raw Value", GLAccount.lvngReportingAccountName);
                if TempDataBuffer.IsEmpty then begin
                    Clear(TempDataBuffer);
                    TempDataBuffer."Raw Value" := GLAccount.lvngReportingAccountName;
