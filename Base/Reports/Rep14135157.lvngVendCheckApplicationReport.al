report 14135157 lvngVendCheckApplicationReport
{
            ...
            dataitem("Bank Account Ledger Entry"; "Bank Account Ledger Entry")
            {
                ...
                dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
                {
                    ...
                    dataitem(AppliedLoop; Integer)
                    {
                        ...
                        column(LoanNo; TempVendLedgerEntry.lvngLoanNo) { }
                        ...
                        dataitem(LoanDetails; Integer)
                        {
                            ...
                            column(LineLoanNo; TempPurchInvLine.lvngLoanNo) { }
                        ...
                        begin
                            ...
                            if PurchInvLine.FindSet() then begin
                                repeat
                                    ...
                                    Clear(TempLoan);
                                    if PurchInvLine.lvngLoanNo <> '' then begin
                                        TempLoan."No." := PurchInvLine.lvngLoanNo;
