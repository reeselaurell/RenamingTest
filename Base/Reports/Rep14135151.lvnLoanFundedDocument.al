report 14135151 "lvnLoanFundedDocument"
{
        ...
        dataitem(lvnLoanFundedDocument; lvnLoanFundedDocument)
        {
            ...
            dataitem(lvnLoanFundedDocumentLine; lvnLoanFundedDocumentLine)
            {
                ...
                begin
                    ...
                    lvnDimensionsManagement.FillDimensionsFromTable(lvnLoanFundedDocumentLine, DimensionValues);
            ...
            begin
                ...
                Clear(State);
                Clear(DimensionValues);
                lvnLoan.Get(lvnLoanFundedDocument."Loan No.");
