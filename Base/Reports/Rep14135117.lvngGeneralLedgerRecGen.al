report 14135117 lvngGeneralLedgerRecGen
{
            ...
            dataitem(Cycle; Integer)
            {
                ...
                begin
                    ...
                    if TempGenRec."Loan No." = '' then begin
                        ...
                        GLEntry.SetRange(lvngLoanNo, TempGenRec."Loan No.");
                                                ...
                                                if GLEntry2.FindSet() then
                                                    repeat
                                                        if GLEntry2.lvngLoanNo <> '' then begin
                                                            ...
                                                            TempGenRec.SetRange("Loan No.", GLEntry2.lvngLoanNo);
                                                            if TempGenRec.FindFirst() then begin
                                                                ...
                                                                Clear(TempGenRec);
                                                                TempGenRec."Entry No." := Index;
                                                                TempGenRec."Loan No." := GLEntry2.lvngLoanNo;
