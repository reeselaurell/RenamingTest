report 14135165 lvngAccountReconByLoan
{
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            trigger OnAfterGetRecord()
            var
                AccountReconByLoan: Query lvngAccountReconByLoan;
                EntryNo: Integer;
            begin
        ...
        layout
        {
            area(Content)
            {
                group(Options)
                {
                    ...
                    field(NumberFormat; NumberFormat) { ApplicationArea = All; Caption = 'Currency Format'; Editable = ExcelToExport; TableRelation = lvngNumberFormat.Code; }
                }
            }
        }
    }
    ...
    trigger OnPreReport()
    var
        OutputFormat: Enum lvngGridExportMode;
    begin
