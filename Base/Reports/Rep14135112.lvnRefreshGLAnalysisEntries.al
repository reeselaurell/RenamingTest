report 14135112 "lvnRefreshGLAnalysisEntries"
{
            ...
            while GLEntryGroupedEntriesQuery.Read() do begin
                ...
                if GLEntryGroupedEntriesQuery.lvnLoanNo <> '' then
                    if GroupedLoanGLEntry.Get(
                            ...
                            GLEntryGroupedEntriesQuery.lvnLoanNo) then begin
                        ...
                        GroupedLoanGLEntry."Loan No." := GLEntryGroupedEntriesQuery.lvnLoanNo;
