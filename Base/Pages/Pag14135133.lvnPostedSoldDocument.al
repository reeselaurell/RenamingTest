page 14135133 "lvnPostedSoldDocument"
{
    Caption = 'Posted Sold Document';
    PageType = Document;
    SourceTable = lvnLoanSoldDocument;
    Editable = false;
    DeleteAllowed = false;
    InsertAllowed = false;
    ...
    layout
    {
        area(Content)
        {
            ...
            part(PostedSoldDocSubpage; lvnPostedSoldDocSubpage)
            {
                Caption = 'Lines';
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(Print)
            {
                ...
                trigger OnAction()
                var
                    LoanSoldDocumentReport: Report lvnLoanSoldDocument;
                    LoanSoldDocumentView: Record lvnLoanSoldDocument;
                begin
