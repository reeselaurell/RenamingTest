page 14135120 "lvnPreviewLoanDocumentLines"
{
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field("Processing Schema Line No."; Rec."Processing Schema Line No.")
                {
                    ApplicationArea = All;
                }
            }
    ...
    procedure SetLines(var LoanDocumentLine: Record lvnLoanDocumentLine)
    begin
