    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field("Borrower First Name"; Rec."Borrower First Name") { Visible = false; ApplicationArea = All; }
                field("Borrower Middle Name"; Rec."Borrower Middle Name") { Visible = false; ApplicationArea = All; }
                field("Borrower Last Name"; Rec."Borrower Last Name") { Visible = false; ApplicationArea = All; }
                field("Co-Borrower First Name"; Rec."Co-Borrower First Name") { Visible = false; ApplicationArea = All; }
                field("Co-Borrower Middle Name"; Rec."Co-Borrower Middle Name") { Visible = false; ApplicationArea = All; }
                field("Co-Borrower Last Name"; Rec."Co-Borrower Last Name") { Visible = false; ApplicationArea = All; }
                field("203K Contractor Name"; Rec."203K Contractor Name") { Visible = false; ApplicationArea = All; }
                field("203K Inspector Name"; Rec."203K Inspector Name") { Visible = false; ApplicationArea = All; }
                ...
                field("Date Locked"; Rec."Date Locked") { Visible = false; ApplicationArea = All; }
                ...
                field("Constr. Interest Rate"; Rec."Constr. Interest Rate") { Visible = false; ApplicationArea = All; }
                field("Monthly Escrow Amount"; Rec."Monthly Escrow Amount") { Visible = false; ApplicationArea = All; }
                field("Monthly Payment Amount"; Rec."Monthly Payment Amount") { Visible = false; ApplicationArea = All; }
                ...
                field("Commission Date"; Rec."Commission Date") { Visible = false; ApplicationArea = All; }
                field("Commission Base Amount"; Rec."Commission Base Amount") { Visible = false; ApplicationArea = All; }
                ...
                field("Creation Date"; Rec."Creation Date") { Visible = false; ApplicationArea = All; }
                field("Modified Date"; Rec."Modified Date") { Visible = false; ApplicationArea = All; }
            }
        }
    }
