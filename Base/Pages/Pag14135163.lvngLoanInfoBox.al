page 14135163 lvngLoanInfoBox
{
    ...
    layout
    {
        area(Content)
        {
            ...
            field("Search Name"; Rec."Search Name") { ApplicationArea = All; Visible = false; }
            ...
            field("Warehouse Line Code"; Rec."Warehouse Line Code") { ApplicationArea = All; Visible = false; }
            field("Loan Amount"; Rec."Loan Amount") { ApplicationArea = All; }
            field("Global Dimension 1 Code"; Rec."Global Dimension 1 Code") { ApplicationArea = All; Visible = false; }
            field("Global Dimension 2 Code"; Rec."Global Dimension 2 Code") { ApplicationArea = All; Visible = false; }
            field("Shortcut Dimension 3 Code"; Rec."Shortcut Dimension 3 Code") { ApplicationArea = All; Visible = false; }
            field("Shortcut Dimension 4 Code"; Rec."Shortcut Dimension 4 Code") { ApplicationArea = All; Visible = false; }
            field("Shortcut Dimension 5 Code"; Rec."Shortcut Dimension 5 Code") { ApplicationArea = All; Visible = false; }
            field("Shortcut Dimension 6 Code"; Rec."Shortcut Dimension 6 Code") { ApplicationArea = All; Visible = false; }
            field("Shortcut Dimension 7 Code"; Rec."Shortcut Dimension 7 Code") { ApplicationArea = All; Visible = false; }
            field("Shortcut Dimension 8 Code"; Rec."Shortcut Dimension 8 Code") { ApplicationArea = All; Visible = false; }
            field("Business Unit Code"; Rec."Business Unit Code") { ApplicationArea = All; Visible = false; }
            ...
            field("First Payment Due To Investor"; Rec."First Payment Due To Investor") { ApplicationArea = All; Visible = false; }
            ...
            field("Borrower SSN"; Rec."Borrower SSN") { ApplicationArea = All; Visible = false; }
            field("Co-Borrower SSN"; Rec."Co-Borrower SSN") { ApplicationArea = All; Visible = false; }
