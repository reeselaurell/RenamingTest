page 14135113 "lvnLoanProcessingSchema"
{
    PageType = List;
    UsageCategory = Lists;
    ApplicationArea = All;
    SourceTable = lvnLoanProcessingSchema;
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field("External Document No. Field"; Rec."External Document No. Field")
                {
                    ApplicationArea = All;
                }
                field("Global Schema"; Rec."Global Schema")
                {
                    ApplicationArea = All;
                }
                field("Use Global Schema Code"; Rec."Use Global Schema Code")
                {
                    ApplicationArea = All;
                }
