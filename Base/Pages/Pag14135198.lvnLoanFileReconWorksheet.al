page 14135198 "lvnLoanFileReconWorksheet"
{
    Caption = 'Loan File Reconciliation';
    PageType = Worksheet;
    ApplicationArea = All;
    UsageCategory = Tasks;
    SourceTable = lvnLoanReconciliationBuffer;
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field("File Amount"; Rec."File Amount")
                {
                    ApplicationArea = All;
                    Editable = false;
                }
                ...
                field(Unbalanced; Rec.Unbalanced)
                {
                    ApplicationArea = All;
                    Editable = false;
                }
            ...
            group(Totals)
            {
                field(EntriesCount; EntriesCount)
                {
                    Caption = 'Entries Count';
                    ApplicationArea = All;
                }
                field(LoanCount; LoanCount)
                {
                    Caption = 'Loans Count';
                    ApplicationArea = All;
                }
                field(DebitAmount; Amounts[1])
                {
                    Caption = 'Debit Amount';
                    ApplicationArea = All;
                }
                field(CreditAmount; Amounts[2])
                {
                    Caption = 'Credit Amount';
                    ApplicationArea = All;
                }
                field(AmountTtl; Amounts[3])
                {
                    Caption = 'Amount';
                    ApplicationArea = All;
                }
                field(FileAmount; Amounts[4])
                {
                    Caption = 'File Amount';
                    ApplicationArea = All;
                }
                field(DifferenceTtl; Amounts[5])
                {
                    Caption = 'Difference';
                    ApplicationArea = All;
                }
    ...
    actions
    {
        area(Processing)
        {
            action(ImportLoanFile)
            {
                ...
                trigger OnAction()
                var
                    LoanFileImport: XMLport lvnLoanReconImport;
                begin
            ...
            action(ReclassEntries)
            {
                ...
                trigger OnAction()
                var
                    ReclassLoanGLEntries: Report lvnReclassLoanGLEntries;
                begin
    ...
    var
        TempLoanReconBuffer: Record lvnLoanReconciliationBuffer temporary;
