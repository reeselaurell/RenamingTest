page 14135138 "lvnLoanJournalLines"
{
    PageType = List;
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field("Borrower Address"; Rec."Borrower Address")
                {
                    ApplicationArea = All;
                }
                field("Borrower Address 2"; Rec."Borrower Address 2")
                {
                    ApplicationArea = All;
                }
                field("Borrower City"; Rec."Borrower City")
                {
                    ApplicationArea = All;
                }
                field("Borrower State"; Rec."Borrower State")
                {
                    ApplicationArea = All;
                }
                field("Borrower ZIP Code"; Rec."Borrower ZIP Code")
                {
                    ApplicationArea = All;
                }
                field("Co-Borrower Address"; Rec."Co-Borrower Address")
                {
                    ApplicationArea = All;
                }
                field("Co-Borrower Address 2"; Rec."Co-Borrower Address 2")
                {
                    ApplicationArea = All;
                }
                field("Co-Borrower City"; Rec."Co-Borrower City")
                {
                    ApplicationArea = All;
                }
                field("Co-Borrower State"; Rec."Co-Borrower State")
                {
                    ApplicationArea = All;
                }
                field("Co-Borrower ZIP Code"; Rec."Co-Borrower ZIP Code")
                {
                    ApplicationArea = All;
                }
                ...
                field("Mailing Address 2"; Rec."Mailing Address 2")
                {
                    ApplicationArea = All;
                }
                field("Mailing City"; Rec."Mailing City")
                {
                    ApplicationArea = All;
                }
                field("Mailing State"; Rec."Mailing State")
                {
                    ApplicationArea = All;
                }
                field("Mailing ZIP Code"; Rec."Mailing ZIP Code")
                {
                    ApplicationArea = All;
                }
                ...
                field("Property Address 2"; Rec."Property Address 2")
                {
                    ApplicationArea = All;
                }
                ...
                field("Processing Schema Code"; Rec."Processing Schema Code")
                {
                    ApplicationArea = All;
                }
                ...
                field("Calculated Document Amount"; Rec."Calculated Document Amount")
                {
                    ApplicationArea = All;
                }
