page 14135256 lvngSalesInvoiceImportJnl
{
    ...
    procedure SetHeaderBuffer(var pSalesInvHdrBuffer: Record lvngSalesInvHdrBuffer)
    begin
    ...
    procedure SetLineBuffer(var pSalesInvLineBuffer: Record lvngSalesInvLineBuffer)
    begin
