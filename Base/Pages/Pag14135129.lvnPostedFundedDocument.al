page 14135129 "lvnPostedFundedDocument"
{
    ...
    layout
    {
        area(Content)
        {
            ...
            part(PostedFundedDocSubpage; lvnPostedFundedDocSubpage)
            {
                Caption = 'Lines';
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(Print)
            {
                ...
                trigger OnAction()
                var
                    LoanFundedDocumentView: Record lvnLoanFundedDocument;
                    LoanFundedDocumentReport: Report lvnLoanFundedDocument;
                begin
