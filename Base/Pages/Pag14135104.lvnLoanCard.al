        ...
        area(Content)
        {
            group(General)
            {
                ...
                group(Borrower)
                {
                    ...
                    field("Borrower Middle Name"; Rec."Borrower Middle Name") { ApplicationArea = All; }
                ...
                group(CoBorrower)
                {
                    ...
                    field("Co-Borrower First Name"; Rec."Co-Borrower First Name") { Importance = Additional; ApplicationArea = All; }
                    field("Co-Borrower Middle Name"; Rec."Co-Borrower Middle Name") { Importance = Additional; ApplicationArea = All; }
                    field("Co-Borrower Last Name"; Rec."Co-Borrower Last Name") { Importance = Additional; ApplicationArea = All; }
                }
                ...
                group(Dates)
                {
                    ...
                    field("Application Date"; Rec."Application Date") { ApplicationArea = All; Importance = Additional; }
                    field("Date Locked"; Rec."Date Locked") { ApplicationArea = All; Importance = Additional; }
                    field("Date Closed"; Rec."Date Closed") { ApplicationArea = All; Importance = Additional; }
                    field("Date Funded"; Rec."Date Funded") { ApplicationArea = All; }
                    field("Date Sold"; Rec."Date Sold") { ApplicationArea = All; }
                    field("Creation Date"; Rec."Creation Date") { Editable = false; ApplicationArea = All; Importance = Additional; }
                    field("Modified Date"; Rec."Modified Date") { Editable = false; ApplicationArea = All; Importance = Additional; }
                }
            ...
            group("203K")
            {
                ...
                field("203K Contractor Name"; Rec."203K Contractor Name") { ApplicationArea = All; Importance = Promoted; }
                field("203K Inspector Name"; Rec."203K Inspector Name") { ApplicationArea = All; Importance = Promoted; }
            }
            ...
            group(Servicing)
            {
                ...
                field("Servicing Finished"; Rec."Servicing Finished") { ApplicationArea = All; }
                field("Loan Term (Months)"; Rec."Loan Term (Months)") { ApplicationArea = All; Importance = Promoted; }
                field("Interest Rate"; Rec."Interest Rate") { ApplicationArea = All; Importance = Promoted; }
                ...
                field("First Payment Due"; Rec."First Payment Due") { ApplicationArea = All; Importance = Promoted; }
                field("Next Payment Date"; Rec."Next Payment Date") { ApplicationArea = All; Importance = Promoted; }
                field("First Payment Due To Investor"; Rec."First Payment Due To Investor") { ApplicationArea = All; Importance = Promoted; }
            }
