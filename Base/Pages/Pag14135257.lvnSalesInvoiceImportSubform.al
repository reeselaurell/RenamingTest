page 14135257 "lvnSalesInvoiceImportSubform"
{
    Caption = 'Sales Invoice Import Lines';
    PageType = ListPart;
    SourceTable = lvnSalesInvLineBuffer;
    InsertAllowed = false;
    ...
    procedure SetSubform(var pSalesInvLineBuffer: Record lvnSalesInvLineBuffer)
    begin
    ...
    procedure UpdateLines(var pSalesInvLineBuffer: Record lvnSalesInvLineBuffer)
    begin
        Rec.Reset();
